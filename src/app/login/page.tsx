...
export default function LoginPage() {
    ...
    return (
            <section className="w-full min-h-[calc(100vh-68px)] flex justify-center items-center">
                <div className="w-100">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <div className="mb-6">
                                <input placeholder="Password" name="password" type="password" required
                                       className="py-2 px-2 text-lg w-full text-black bg-gray-50 border-1 border-gray-400 rounded-lg"
                        ...
                        <div>
                            <div>
                                <Button disabled={loading} type="submit"
                                        className="py-2 px-2 w-full bg-gray-700 text-white rounded-lg hover:bg-black border-1 border-gray-700 text-sm ">
